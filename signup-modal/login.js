...
function enableButton(letter, capital, number, length, match) {
    ...
    var number = /[0-9]/g;
    var passEqualsConfPass = (document.getElementById("psw").value == document.getElementById())
    var l = myInput.value.length >= 8;
    var n = myInput.value.match(numbers);
    var u = myInput.value.match(upperCaseLetters);
    var lc = myInput.value.match(lowerCaseLetters);
